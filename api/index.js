...
const fs = require("fs").promises; // Promises API para leer/escribir archivos
const path = require("path"); // Para componer rutas de forma segura
...
app.patch(`${PREFIX}/tasks/:id`, async (req, res) => {
...
app.delete(`${PREFIX}/tasks/:id`, async (req, res) => {
  const tasks = await readTasks();
  const { id } = req.params;
